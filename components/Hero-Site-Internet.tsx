...
const HeroSiteInternet = () => {
  ...
  const slides = [
    {
      title: "Créez Votre Site Internet Professionnel",
      subtitle: "Solutions Web Sur Mesure pour Votre Entreprise",
      features: [
    ...
    },
    {
      ...
      subtitle: "Des Sites Web qui Convertissent",
      features: [
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12">
        <div className="flex flex-col gap-6 md:gap-8">
          ...
          <div className="hidden md:grid md:grid-cols-2 items-center">
            ...
            <div className="relative h-[300px] md:h-[400px] w-full animate-fade-in">
              <Image
                ...
                alt="Création de site internet professionnel au Maroc"
                fill
          ...
          <div className={`text-center ${currentSlideData.textColorClass} mt-8`}>
            <p className="text-lg">
              Nous créons des sites web professionnels et performants pour les entreprises au Maroc. 
              De la conception au développement, nous vous accompagnons dans votre transformation digitale.
            </p>
          </div>
